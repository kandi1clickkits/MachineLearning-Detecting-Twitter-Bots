...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/MachineLearning-Detecting-Twitter-Bots/releases/download/v1.0.0/Twitter-Bot-detection.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/MachineLearning-Detecting-Twitter-Bots/raw/master/requirements.txt
SET REPO_NAME=Twitter-Bot-detection.zip
SET EXTRACTED_REPO_DIR=Twitter-Bot-detection
SET NOTEBOOK_NAME=Bot-Detection-App.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
